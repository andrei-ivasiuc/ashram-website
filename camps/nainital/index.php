    ...
    <div class="container">
        <div class="row gx-5">
            <div class="col-4 offset-lg-1 d-flex flex-column justify-content-center text-center pt-5 pb-5">
                ...
                <h2 class="mb-4">Nainital</h2>
                <p class="fs-5 mb-4">Van Niwas is a serene mountainous abode nestled in the Uttarakhand hills of the Himalayas.</p>
