        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 col-sm-12 fs-5 p-5">
                    <h2 class="fs-3">Spirituality in a Householder’s Life:</h2>
                    <h1>Opportunities Galore</h1>
                    <h3>Ayesha Sengupta Sarkar</h3>
                    <h6>The Call Beyond | 15 February 2020 </h6>
                    <br>
                    <p>
